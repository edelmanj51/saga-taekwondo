...
const REQUIRED = [
  ...
  // NOTE: YEAR_FOUNDED intentionally omitted — school opened Nov 2025, IF blocks hide year stats
...
if (data.YEAR_FOUNDED) data.YEARS_COUNT = String(new Date().getFullYear() - parseInt(data.YEAR_FOUNDED, 10));
